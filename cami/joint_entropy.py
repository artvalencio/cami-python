def joint_entropy(x,y,x_divs=None,y_divs=None,symbolic_type='equal-divs',n_symbols=2,symbolic_length=1,tau=1,delay=0,units='bits'):
    ...
    H=joint_entropy(x,y,x_divs=[0.2,0.5],y_divs=[0.3,0.7])
    '''
